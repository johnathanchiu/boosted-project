...
static struct gatts_char_profile gl_conn_svc_char_profile_tab[CONNECTIVITY_PROFILE_NUM_CHARS] = {
    [PROFILE_CONNECTIVITY_CHAR1_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x7A, 0x4C, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
    ...
    [PROFILE_CONNECTIVITY_CHAR2_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x7D, 0x8A, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
        .perm = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
        .property = ESP_GATT_CHAR_PROP_BIT_WRITE,
    ...
    [PROFILE_CONNECTIVITY_CHAR3_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x7E, 0x66, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
        .perm = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
        .property = ESP_GATT_CHAR_PROP_BIT_WRITE,
    ...
    [PROFILE_CONNECTIVITY_CHAR4_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x29, 0xF3, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
        .perm = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
        .property = ESP_GATT_CHAR_PROP_BIT_WRITE,
    ...
    [PROFILE_CONNECTIVITY_CHAR5_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x80, 0x32, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
        .perm = ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
        .property = ESP_GATT_CHAR_PROP_BIT_WRITE,
    ...
    [PROFILE_CONNECTIVITY_CHAR6_ID] = {
        .char_uuid = {
            .len = ESP_UUID_LEN_128,
            .uuid = {
                .uuid128 = {0xF4, 0xC4, 0x29, 0x3F, 0x00, 0x56, 0x11, 0xE6, 0x8D, 0x22, 0x5E, 0x55, 0x17, 0x50, 0x7C, 0x66},
            },
        },
